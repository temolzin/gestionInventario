                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    @if ($user->getFirstMediaUrl('userGallery'))
                                        <img src="{{ $user->getFirstMediaUrl('userGallery') }}" alt="Foto del usuario" class="img-fluid" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 5px;">
                                    @else
                                        <img src="{{ asset('img/userDefault.png') }}" alt="Foto del usuario" class="img-fluid" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 5px;">
                                    @endif
                                </div>
                                <div class="col-lg-6">
