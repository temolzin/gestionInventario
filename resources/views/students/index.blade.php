            ...
            <div class="x_panel">
                ...
                <form method="GET" action="{{ route('students.index') }}" class="my-3">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control" placeholder="Buscar por nombre, apellido, matrícula" value="{{ request('search') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <table id="students" class="table table-striped display responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>MATRÍCULA</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if ($student->getFirstMediaUrl('studentGallery'))
                                                <img src="{{$student->getFirstMediaUrl('studentGallery') }}" alt="Foto de {{$student->name}}" style="width: 50px; height: 50px; border-radius: 50%;">
                                            @else
