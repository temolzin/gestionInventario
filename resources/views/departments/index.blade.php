                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="departments" class="table table-striped display responsive nowrap"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Opciones">
                                                                <button type="button" class="btn btn-info mr-2"
                                                                    ...
                                                                    data-target="#view{{ $department->id }}">
                                                                ...
                                                                <button type="button" class="btn btn-primary mr-2"
                                                                    ...
                                                                    data-target="#editPhoto{{ $department->id }}">
